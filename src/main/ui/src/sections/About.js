	...
	return (
		...
		<div className="mx-auto w-3/4 flex justify-center md:h-[60vh]">
			<div className="flex flex-col gap-4 mt-6 border-t-2">
				...
				<p>
					<a href={'https://www.borisblagojevic.me'} target={'_blank'} className='hover:text-mint font-semibold'>Boris Blagojević</a> rođen je 22. septembra 1995. godine u Banjoj Luci. Završio je osnovnu školu u Banjoj Luci, nakon čega je upisao Srednju elektrotehničku školu "Nikola Tesla" takođe u Banjoj Luci, gdje je stekao zvanje tehničara telekomunikacija i maturirao 2014. godine.
				</p>
