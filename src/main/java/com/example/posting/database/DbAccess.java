...
{
	private final String CONNECTIONURL = "jdbc:mysql://localhost:3306/jobPostingsDB", // TODO: change port if necessary (this is primitive will be updated when docker container for tomcat is made and docker compose is used)
			USERNAME = "root",
...
//            ResultSet resultSet = statement.executeQuery("SELECT * FROM posts;");
	 ...
	 */
	public ResultSet checkIfExist(List<String> parameters)
	{
		...
		try
		{
			...
			return statment.executeQuery("SELECT * FROM " + parameters.get(0) + " WHERE " + parameters.get(1) + "='" + parameters.get(2) + "';");
